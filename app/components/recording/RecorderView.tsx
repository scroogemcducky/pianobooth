// Frame-by-frame video recorder: renders MIDI piano visualisation offline for
// video creation, driven by the Playwright scripts in scripts/.
//
// A plain component, not a route module: React Router wraps route default
// exports in withComponentProps, which would discard the `recordingPreset` prop.
// The /record and /record_mobile routes are thin wrappers around this.

import React, { useState, useEffect, useRef } from 'react'
import { Canvas, useThree } from '@react-three/fiber'
import midiParser from '../../utils/MidiParser'
import useMidiStore from '../../store/midiStore'
import FrameBasedShaderBlocks, { type FrameBasedShaderBlocksHandle } from './FrameBasedShaderBlocks'
import FrameBasedTitle, { type FrameBasedTitleHandle } from './FrameBasedTitle'
import FrameBasedKeyController, { type FrameBasedKeyControllerHandle } from './FrameBasedKeyController'
import FrameBasedParticles, { type FrameBasedParticlesHandle } from './FrameBasedParticles'
...
export default function RecorderView({ recordingPreset = DESKTOP_RECORDING_PRESET }: { recordingPreset?: RecordingPreset } = {}) {
