...
export const allPieces: Record<string, { title: string; url: string }[]> = {
  ...
  "Brahms": [
    ...
    { title: "Intermezzo Opus 117 Nr. 2", url: "/brahms/brahms-intermezzo-opus-117-nr-2" },
  ...
  "Chopin": [
    { title: "Ballade in G minor Opus 32", url: "/chopin/chopin-ballade-in-g-minor-opus-32" },
    { title: "Etude No. 1, Opus 25", url: "/chopin/chopin-etude-no-1-opus-25" },
    { title: "Etude No. 2, Opus 25", url: "/chopin/chopin-etude-no-2-opus-25" },
    { title: "Etude No. 3, Opus 25", url: "/chopin/chopin-etude-no-3-opus-25" },
    { title: "Etude No. 4, Opus 25", url: "/chopin/chopin-etude-no-4-opus-25" },
    { title: "Etude No. 12, Opus 25", url: "/chopin/chopin-etude-no-12-opus-25" },
    ...
    { title: "Mazurka Opus 7 No. 1", url: "/chopin/chopin-mazurka-opus-7-no-1" },
    { title: "Mazurka Opus 7 No. 2", url: "/chopin/chopin-mazurka-opus-7-no-2" },
    { title: "Mazurka Opus 33 Nr. 2", url: "/chopin/chopin-mazurka-opus-33-nr-2" },
    { title: "Mazurka Opus 33 Nr. 4", url: "/chopin/chopin-mazurka-opus-33-nr-4" },
    { title: "Nocturne Opus 27 Nr. 1", url: "/chopin/chopin-nocturne-opus-27-nr-1" },
    { title: "Nocturne Opus 27 Nr. 2", url: "/chopin/chopin-nocturne-opus-27-nr-2" },
    { title: "Polonaise in Ab major Opus 53", url: "/chopin/chopin-polonaise-in-ab-major-opus-53" },
    { title: "Prelude No. 1, Opus 28", url: "/chopin/chopin-prelude-no-1-opus-28" },
    { title: "Prelude No. 2, Opus 28", url: "/chopin/chopin-prelude-no-2-opus-28" },
    { title: "Prelude No. 3, Opus 28", url: "/chopin/chopin-prelude-no-3-opus-28" },
    { title: "Prelude No. 4, Opus 28", url: "/chopin/chopin-prelude-no-4-opus-28" },
    { title: "Prelude No. 5, Opus 28", url: "/chopin/chopin-prelude-no-5-opus-28" },
    { title: "Prelude No. 6, Opus 28", url: "/chopin/chopin-prelude-no-6-opus-28" },
    ...
    { title: "Prelude No. 12, Opus 28", url: "/chopin/chopin-prelude-no-12-opus-28" },
    { title: "Prelude No. 13, Opus 28", url: "/chopin/chopin-prelude-no-13-opus-28" },
    { title: "Prelude No. 14, Opus 28", url: "/chopin/chopin-prelude-no-14-opus-28" },
    { title: "Prelude No. 15, Opus 28", url: "/chopin/chopin-prelude-no-15-opus-28" },
    { title: "Prelude No. 16, Opus 28", url: "/chopin/chopin-prelude-no-16-opus-28" },
    { title: "Prelude No. 17, Opus 28", url: "/chopin/chopin-prelude-no-17-opus-28" },
    { title: "Prelude No. 18, Opus 28", url: "/chopin/chopin-prelude-no-18-opus-28" },
    { title: "Prelude No. 19, Opus 28", url: "/chopin/chopin-prelude-no-19-opus-28" },
    { title: "Prelude No. 20, Opus 28", url: "/chopin/chopin-prelude-no-20-opus-28" },
    { title: "Prelude No. 21, Opus 28", url: "/chopin/chopin-prelude-no-21-opus-28" },
    { title: "Prelude No. 22, Opus 28", url: "/chopin/chopin-prelude-no-22-opus-28" },
    { title: "Prelude No. 23, Opus 28", url: "/chopin/chopin-prelude-no-23-opus-28" },
    { title: "Prelude No. 24, Opus 28", url: "/chopin/chopin-prelude-no-24-opus-28" },
  ...
  "Clementi": [
    ...
    { title: "Sonatine Opus 36 Nr. 1, 1. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-1-1-satz" },
    { title: "Sonatine Opus 36 Nr. 1, 2. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-1-2-satz" },
    { title: "Sonatine Opus 36 Nr. 1, 3. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-1-3-satz" },
    { title: "Sonatine Opus 36 Nr. 2, 1. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-2-1-satz" },
    { title: "Sonatine Opus 36 Nr. 2, 2. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-2-2-satz" },
    { title: "Sonatine Opus 36 Nr. 2, 3. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-2-3-satz" },
    { title: "Sonatine Opus 36 Nr. 3, 1. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-3-1-satz" },
    { title: "Sonatine Opus 36 Nr. 3, 2. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-3-2-satz" },
    { title: "Sonatine Opus 36 Nr. 3, 3. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-3-3-satz" },
    { title: "Sonatine Opus 36 Nr. 4, 1. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-4-1-satz" },
    { title: "Sonatine Opus 36 Nr. 4, 2. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-4-2-satz" },
    { title: "Sonatine Opus 36 Nr. 4, 3. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-4-3-satz" },
    { title: "Sonatine Opus 36 Nr. 5, 1. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-5-1-satz" },
    { title: "Sonatine Opus 36 Nr. 6, 1. Satz", url: "/clementi/clementi-sonatine-opus-36-nr-6-1-satz" }
  ],
  "Debussy": [
  ...
  "Grieg": [
    { title: "Berceuse Opus 38 Nr. 1", url: "/grieg/grieg-berceuse-opus-38-nr-1" },
    ...
    { title: "Lyrische Stücke Op. 12 Nr. 4 Elfentanz", url: "/grieg/grieg-lyrische-stucke-op-12-nr-4-elfentanz" },
    { title: "Lyrische Stücke Op. 43 No. 1 - Schmetterling", url: "/grieg/grieg-lyrische-stucke-op-43-no-1-schmetterling" },
    { title: "Lyrische Stücke Op. 43 Nr. 2 - Einsamer Wanderer", url: "/grieg/grieg-lyrische-stucke-op-43-nr-2-einsamer-wanderer" },
    { title: "Lyrische Stücke Op. 43 Nr. 6 - An den Frühling", url: "/grieg/grieg-lyrische-stucke-op-43-nr-6-an-den-fruhling" },
    { title: "Lyrische Stücke, Albumblatt, Opus 42 Nr. 2", url: "/grieg/grieg-lyrische-stucke-albumblatt-opus-42-nr-2" },
    { title: "Lyrische Stücke, Bächlein, Opus 62 Nr. 4", url: "/grieg/grieg-lyrische-stucke-bachlein-opus-62-nr-4" },
    { title: "Lyrische Stücke, Es war einmal, Opus 71 Nr. 1", url: "/grieg/grieg-lyrische-stucke-es-war-einmal-opus-71-nr-1" },
    { title: "Lyrische Stücke, Norwegischer Bauernmarsch, Opus 54 Nr. 2", url: "/grieg/grieg-lyrische-stucke-norwegischer-bauernmarsch-opus-54-nr-2" },
  ...
  "Mendelssohn": [
    ...
    { title: "Lieder ohne Worte Opus 19 Nr. 1", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-19-nr-1" },
    { title: "Lieder ohne Worte Opus 19 Nr. 2", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-19-nr-2" },
    { title: "Lieder ohne Worte Opus 19 Nr. 4", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-19-nr-4" },
    { title: "Lieder ohne Worte Opus 19 Nr. 5", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-19-nr-5" },
    { title: "Lieder ohne Worte Opus 30 Nr. 2", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-30-nr-2" },
    { title: "Lieder ohne Worte Opus 30 Nr. 3", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-30-nr-3" },
    { title: "Lieder ohne Worte Opus 30 Nr. 4", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-30-nr-4" },
    { title: "Lieder ohne Worte Opus 30 Nr. 5", url: "/mendelssohn/mendelssohn-lieder-ohne-worte-opus-30-nr-5" },
